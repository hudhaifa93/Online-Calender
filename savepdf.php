...
<script>
    ...
    function exportPDF() {
        ...
        var header = function (doc, pageCount, options) {
            ...
            doc.setFontSize(20);
            doc.text("Export List", options.margins.horizontal + 40, 60);
        ...
        var footer = function (doc, lastCellPos, pageCount, options) {
            ...
            doc.text(str+" | * Exported By Code Hunters - Online Calender *" , options.margins.horizontal, doc.internal.pageSize.height - 30);
